...
COS_API_KEY_ID="15iJb-sk-Kaf1guOPEJJTgrqJC6XRc8dAalFSAxMq1-a"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/dedde73d33c54045a93f6a28c1ff6111:b5b6c137-4529-4602-8779-e0620bdbbd21::"
...
@app.route('/')
def index():
    files = get_bucket_contents('psgitech')
